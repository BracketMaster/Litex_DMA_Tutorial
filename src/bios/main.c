...
#ifdef CSR_YOSHI_BASE
yoshi_ev_enable_write(1);
irq_setmask(irq_getmask() | (1 << YOSHI_INTERRUPT));
yoshi_sdram_initialized_write(1);
flush_cpu_dcache();
flush_l2_cache();
yoshi_sdram_initialized_write(1);
#endif
...
// 1027527
int *write_zero;
write_zero  = 0x40000000;
*write_zero = 0xa6a6a6a6;
// 1027624
flush_cpu_dcache();
// 1045208
flush_l2_cache();
